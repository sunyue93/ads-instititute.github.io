...
image_url:  http://ads-institute.uw.edu/images/faster_lp.pdf
categories: hidden
---
...
discuss the [recent result](http://ads-institute.uw.edu/images/faster_lp.pdf) of [Michael Cohen](https://dblp.uni-trier.de/pers/hd/c/Cohen:Michael_B=), [Zhao Song](https://dblp.uni-trier.de/pers/hd/s/Song:Zhao) and me about  
...
$$s\leftarrow s+\tilde{w}{\delta}_{s}$$ and $$y\leftarrow y+ \tilde{w}{\delta}_{y}$$ are defined by <a id="tilde_delta_x_s_y_mu"></a>
